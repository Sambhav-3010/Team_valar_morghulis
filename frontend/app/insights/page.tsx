...
import { Sparkles, Filter, Lightbulb, AlertTriangle, TrendingUp, Loader2, RefreshCw } from 'lucide-react';

type CategoryFilter = 'all' | 'observation' | 'anomaly' | 'trend' | 'suggestion' | 'risk' | 'praise' | 'workload' | 'process';
...
export default function InsightsPage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto">
      ...
      <div className="mb-10">
        <InsightStream
          message={`Fetched ${insights.length} insights from backend. Filter by category or perspective to focus on specific areas.`}
          typing
        />
      </div>
